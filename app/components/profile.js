// this is too big and the form elements should get broken down so there is not so much repeat elements
// seperate the information into contact information and user information
// include a add user button to submit information contact buy contact
// this can be where the new forms are brought together 
// I think this should become a functional conponent
// the forms are going to need to be class components because of the need to have controlled inputs
